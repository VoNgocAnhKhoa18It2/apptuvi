...
public class MainActivity extends AppCompatActivity {
    ...
    private Button btntailieu,btnansao,btnLuuSo,btnDanhSach;
    private EditText txtNgay;
    ...
    private void Anhxa() {
        ...
        btntailieu = findViewById(R.id.btntailieu);
        ...
        btnansao.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(),AnsaoActivity.class);
                startActivity(intent);
            }
        });
        ...
        btntailieu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(),TailieuActivity.class);
                startActivity(intent);
            }
        });
